...
var LS = {
  Str:{
    ...
    AVG_MOUNT_COPY:["每笔跟随BHT","BHT per time"],
    ...
    YOU_ARE_LOGIN:["您正在登录BHT市场","You are login BHT market"],
    FAST_LOGIN:["快速登录","Fast Login"],
    LOGIN:["登录","Login"],
    TOTAL_MOUNT:["总BHT","Total BHT"],
    REMAIN_MOUNT:["剩余BHT","Remain BHT"],
    SHARE:["分享","Share"],
    ...
    BIND_PURSE_HINT: ["绑定须知：入金前需要绑定您的钱包地址，钱包地址绑定后，入金才能和BHT账户关联起来！", "Binding Notice: You need to bind your wallet address before Deposit, After binding, funds can be associated with the token account."],
    BIND_CONFIRM: ["确认绑定", "Confirm binding"],
    BIND_PURSE_HEADER: ["绑定钱包地址", "Bind wallet address"],
    DEPOSIT_COPY_YJY_ADDRESS: ["复制盈交易收款地址", "Copy wallet address of BHT"],
    DEPOSIT_YJY_ADDRESS: ["盈交易收款地址: ", "Wallet address of BHT: "],
    DEPOSIT_HINT_1: ["注册以太坊钱包: ", "Registered Ethereum Wallet: "],
    DEPOSIT_HINT_2: ["以太坊官网: ", "Ethereum Website: "],
    DEPOSIT_HINT_3: ["用户把自己的Token转入盈交易: ", "Users transfer their Token to BHT"],
    DEPOSIT_COPY_SUCCESS: ["复制成功", "Successful"],
    DEPOSIT_AGREEMENT: ["《购买BHT协议内容》", "《Candy clause》"],
    ...
    WITHDRAW_CANDY: ["BHT", "BHT"],
    WITHDRAW_ALL: ['全部出金', 'Withdraw all'],
    WITHDRAW_AVAILABLE_AMOUNT: ['可出资金：{1}BHT，', 'Withdraw Limit :{1} BHT,'],
    ...
    COPY_AMOUNT: ["每笔跟随BHT", "BHT"],
    COPY_COUNT: ["跟随笔数", "Times"],

    ORDER_TYPE:['类型','type'],
    ORDER_SUGAR_AMOUNT: ["BHT", "BHT"],
    ORDER_MULTIPLE: ["倍数", "Multiple"],
    ORDER_TRADE_PRICE: ["交易价格", "Trade Price"],
    ORDER_MAX_RISK: ["最大风险（BHT）", "Maximum Risk"],
    ORDER_PROFIT_AND_LOSS: ["盈亏（BHT）", "Profit / loss (BHT)"],
