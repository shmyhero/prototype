...
@VisibleForTesting
public class CustomTextInputShadowNode extends ReactBaseTextShadowNode
    implements YogaMeasureFunction {

  private int mMostRecentEventCount = UNSET;
  private @Nullable EditText mDummyEditText;
  private @Nullable CustomTextInputLocalData mLocalData;
  ...
  public CustomTextInputShadowNode() {
  ...
  public void setLocalData(Object data) {
    Assertions.assertCondition(data instanceof CustomTextInputLocalData);
    mLocalData = (CustomTextInputLocalData) data;
